...
public class Object {
    ...
    public static void updateAll() {
        ...
        //**********  OBJECTS UPDATE  *************************************************************
        if (countBot==0) GameLevel.nextWave();
        ...
        for (int i=0;i<countBot;i++) {
            ...
            for (int j=0;j<countBullet;j++) if (!bullets[j].getDead() && !bullets[j].getEnemy()) {
                ...
                if (t.isBoss) {
                    ...
                    if (Self.collide(t, center, Self.distance(center,corner))) {
        ...
        for (int i=0;i<countBot;i++) if (bots[i].needDestruct()) {
            if (!bots[i].oos()) {
        ...
        System.out.println(boss1.getX() + " " + boss1.getY() + " " + boss1.getDead());
    }
