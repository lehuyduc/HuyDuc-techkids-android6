...
public class GameWindow extends Frame implements Runnable {
    ...
    public void update(Graphics g) {
        ...
        for (int i = 0;i < Object.countBot; i++) if (Object.bots[i]!=null && !Object.bots[i].getDead())
        ...
        for (int i = 0;i<Object.countExplosion;i++) {
            if (Object.explosions[i].getPhoto()!=null) Object.explosions[i].drawImage(backBufferGraphics);
        }
