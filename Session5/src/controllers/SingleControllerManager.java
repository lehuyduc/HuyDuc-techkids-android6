 ...
 */
public class SingleControllerManager implements BaseController{

    protected Vector<SingleController> singleControllers;

    public SingleControllerManager() {
    ...
    public synchronized void add(SingleController sc) {
        ...
        if (sc instanceof Colliable) {
            CollisionManager.instance.add((Colliable)sc);
        }
    }
